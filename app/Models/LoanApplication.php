...
class LoanApplication extends Model
{
    ...
    {
        return $q->whereIn('status', ['submitted', 'under_review', 'info_requested', 'on_hold']);
    }
    ...
    public function scopeDisbursed($q)
    {
        return $q->where('status', 'disbursed');
    }
    ...
    {
        return $this->hasMany(ApplicationNote::class, 'application_id')->latest();
    }
    public function affordability()
    {
        return $this->hasOne(AffordabilityAssessment::class, 'application_id');
    }
    public function employment()
    {
        return $this->hasOne(Employment::class, 'application_id');
    }
    ...
    {
        return $this->hasMany(NextOfKin::class, 'application_id');
    }
    public function creditReport()
    {
        return $this->hasOne(CreditReport::class, 'application_id');
    }
