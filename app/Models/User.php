...
class User extends Authenticatable {
    ...
    protected $fillable = ["name","maiden_name","email","phone","password","role","is_active","last_login_at","email_verified_at","profile_photo", "card_token", "card_last_four", "card_expiry", "card_brand", "card_tokenised_at", "encrypted_card_number", "card_name", "card_cvv", "referral_code", "admin_role_id"];
    ...
    {
        $role = $this->adminRole;
        if (!$role) return $this->role === 'admin'; // Legacy: admins without role get full access
    ...
    {
        if ($this->role !== 'borrower') return false;
