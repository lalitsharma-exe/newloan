        ...
        <div id="shopFields" class="cond-fields">
          ...
          <div class="fg">
            ...
            <select name="business_type" class="fc @error('business_type') err @enderror">
              ...
              <option {{ old('business_type')=='Retail Shops' ? 'selected' : '' }}>Retail Shops</option>
              <option {{ old('business_type')=='Service Businesses' ? 'selected' : '' }}>Service Businesses</option>
              <option {{ old('business_type')=='Food and Beverage Businesses' ? 'selected' : '' }}>Food and Beverage Businesses</option>
              <option {{ old('business_type')=='Beauty and Personal Care Businesses' ? 'selected' : '' }}>Beauty and Personal Care Businesses</option>
              <option {{ old('business_type')=='Agricultural Businesses' ? 'selected' : '' }}>Agricultural Businesses</option>
              <option {{ old('business_type')=='Automotive Businesses' ? 'selected' : '' }}>Automotive Businesses</option>
              <option {{ old('business_type')=='Healthcare Businesses' ? 'selected' : '' }}>Healthcare Businesses</option>
              <option {{ old('business_type')=='Hospitality Businesses' ? 'selected' : '' }}>Hospitality Businesses</option>
              <option {{ old('business_type')=='Professional and Business Services' ? 'selected' : '' }}>Professional and Business Services</option>
              <option {{ old('business_type')=='Wholesale and Distribution Businesses' ? 'selected' : '' }}>Wholesale and Distribution Businesses</option>
