...
<title>Application Submitted — Prosperity Loans Agent</title>
...
.check-circle{width:72px;height:72px;background:rgba(22,163,74,.12);border-radius:50%;display:flex;align-items:center;justify-content:center;margin:0 auto 20px;font-size:32px;color:#10b981}
