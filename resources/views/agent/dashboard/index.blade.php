...
{{-- Commission Banner --}}
<div style="background:linear-gradient(135deg,#134e4a,#0f766e);border-radius:16px;padding:22px 26px;margin-bottom:22px;color:#fff;display:flex;align-items:center;gap:16px;flex-wrap:wrap">
  ...
  <div style="overflow-x:auto">
    <table class="dt">
      ...
      <tbody>
        ...
        <tr>
          <td><a href="{{ route('agent.applications.show', $app) }}" style="color:#0f766e;font-weight:600;text-decoration:none">{{ $app->application_number }}</a></td>
        ...
        @empty
        <tr><td colspan="5" style="text-align:center;color:#64748b;padding:30px">No applications yet. <a href="{{ route('agent.applications.create') }}" style="color:#0f766e">Submit your first one →</a></td></tr>
        @endforelse
      </tbody>
    </table>
  </div>
