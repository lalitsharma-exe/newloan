...
<style>
*{box-sizing:border-box;margin:0;padding:0}body{font-family:'Outfit',sans-serif;min-height:100vh;display:flex;align-items:center;justify-content:center;background:linear-gradient(160deg,#042f2e,#134e4a)}
...
.fc{width:100%;padding:11px 13px;border:1.5px solid #d1e7dd;border-radius:8px;font-size:14px;font-family:'Outfit',sans-serif;outline:none}
.fc:focus{border-color:#0f766e;box-shadow:0 0 0 3px rgba(15,118,110,.1)}
.btn-p{width:100%;padding:13px;border-radius:8px;border:none;background:#0f766e;color:#fff;font-size:14px;font-weight:700;cursor:pointer;font-family:'Outfit',sans-serif}
.btn-p:hover{background:#0d5b55}
.auth-success{background:rgba(16,185,129,.08);border:1px solid rgba(16,185,129,.2);color:#065f46;padding:10px 14px;border-radius:8px;font-size:13px;margin-bottom:16px}
