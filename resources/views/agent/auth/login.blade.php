...
.brand-pill-icon {
  ...
  background: rgba(201,148,58,.2); display: flex; align-items: center; justify-content: center;
  color: #e0a843; font-size: 15px;
}
...
.fc {
  ...
  background: #fff; outline: none; color: #0f2a1a; transition: all .2s;
}
...
.register-link { display: block; text-align: center; margin-top: 18px; padding: 12px; background: rgba(26,107,60,.08); border: 1px solid rgba(26,107,60,.2); border-radius: 8px; text-decoration: none; color: #1a6b3c; font-size: 13px; font-weight: 600; transition: all .2s; }
.register-link:hover { background: rgba(26,107,60,.15); }
@media(max-width: 768px) {
  ...
  .register-link { border-color: rgba(255,255,255,.15); color: #e0a843; background: rgba(255,255,255,.05); }
}
</style>
</head>
<body>
  ...
  <div class="auth-brand">
    <div class="brand-logo">
      ...
      <div>
        ...
        <div class="brand-logo-sub">Agent Portal</div>
      </div>
    </div>
    <div class="brand-body">
      <h2>Community <em>Agent</em><br>Portal</h2>
      <p>Earn commission per qualifying loan application. Serve your community as a Prosperity Loans agent from your shop or anywhere.</p>
    ...
    <div class="brand-foot">© {{ date('Y') }} {{ config('app.name') }} · Licensed by the Central Bank of Lesotho</div>
  </div>
      ...
      <form method="POST" action="{{ route('agent.login.post') }}">
        ...
        <div class="fg">
          ...
          <div class="field-wrap">
            ...
            <input type="email" name="email" class="fc" value="{{ old('email') }}" placeholder="agent@prosperityloans.co.ls" required autofocus>
          </div>
        </div>
        <div class="fg">
