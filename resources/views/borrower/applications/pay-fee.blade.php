  ...
  <div class="card" style="margin-bottom:24px;">
    ...
    <div style="padding:20px 22px">
      <form method="POST" action="{{ route('borrower.apply.pay-fee.initiate', $application) }}" id="payForm">
        ...
        {{-- Method Info Boxes --}}
        <div id="cardInfo" class="info-box" style="{{ $mpesaConfigured ? 'display:none;' : '' }}background:rgba(22,163,74,.05);border:1px solid rgba(22,163,74,.2)">
        ...
        {{-- Pay Summary --}}
        <div style="background:linear-gradient(135deg,var(--navy),#1a6b3c);border-radius:14px;padding:16px 20px;margin-bottom:18px;display:flex;align-items:center;justify-content:space-between">
          <div>
