...
<title>Verify Phone — Prosperity Loans Portal</title>
...
body{background:linear-gradient(160deg,#050f06 0%,#0f4527 40%,#1a6b3c 70%,#0f4527 100%);min-height:100vh;display:flex;align-items:center;justify-content:center;padding:32px 20px}

.card{background:#fff;border-radius:18px;box-shadow:0 24px 80px rgba(7,14,36,.5);width:100%;max-width:420px;overflow:hidden}
.card-top{background:linear-gradient(135deg,#0f4527,#22894e);padding:28px 32px 24px;text-align:center}
...
/* Icon badge */
.icon-badge{width:68px;height:68px;border-radius:50%;background:linear-gradient(135deg,rgba(26,107,60,.12),rgba(26,107,60,.06));border:2px solid rgba(26,107,60,.2);display:flex;align-items:center;justify-content:center;margin:0 auto 20px;font-size:28px;color:#1a6b3c}

.phone-display{background:#f8faff;border:1.5px solid #d4e0d4;border-radius:9px;padding:10px 14px;text-align:center;margin-bottom:22px}
.phone-display strong{font-size:15px;color:#1c2433;font-weight:700}
.phone-display small{display:block;font-size:11.5px;color:#8aaa8a;margin-top:2px}

/* OTP input — large digits */
.otp-wrap{display:flex;gap:10px;justify-content:center;margin-bottom:22px}
.otp-digit{
  width:46px;height:58px;border:2px solid #d4e0d4;border-radius:10px;
  font-size:24px;font-weight:700;text-align:center;color:#0f4527;
  font-family:'DM Sans',sans-serif;background:#fff;outline:none;
  transition:all .2s;
}
.otp-digit:focus{border-color:#1a6b3c;box-shadow:0 0 0 3px rgba(26,107,60,.1);background:#f8faff}
.otp-digit.filled{border-color:#1a6b3c;background:#f0f4ff}
...
.alert-ok{background:rgba(22,163,74,.08);border:1px solid rgba(22,163,74,.2);color:#065f46;padding:10px 14px;border-radius:8px;font-size:13px;margin-bottom:16px;display:flex;align-items:center;gap:8px}

.btn-verify{width:100%;padding:13px;border-radius:9px;border:none;background:linear-gradient(135deg,#0f4527,#22894e);color:#fff;font-size:15px;font-weight:700;font-family:'DM Sans',sans-serif;cursor:pointer;transition:all .3s;display:flex;align-items:center;justify-content:center;gap:8px;box-shadow:0 4px 16px rgba(15,69,39,.25)}
.btn-verify:hover{background:linear-gradient(135deg,#1a6b3c,#1a6b3c);transform:translateY(-1px)}
.btn-verify:disabled{opacity:.6;cursor:not-allowed;transform:none}

.resend-row{text-align:center;margin-top:16px;font-size:13px;color:#8aaa8a}
.resend-row button{background:none;border:none;color:#1a6b3c;font-weight:700;font-size:13px;font-family:'DM Sans',sans-serif;cursor:pointer;padding:0}
.resend-row button:hover{text-decoration:underline}

.timer{color:#8aaa8a;font-size:12px}
.help{font-size:12px;color:#8aaa8a;text-align:center;line-height:1.6;margin-top:16px;border-top:1px solid #f4f7f4;padding-top:16px}
</style>
</head>
<body>
<div class="card">
  ...
  <div class="card-body">
    ...
    <div class="help">
      ...
      Wrong number? <a href="{{ route('borrower.logout') }}" style="color:#1a6b3c">Sign out</a> and register again.
    </div>
  </div>
</div>
