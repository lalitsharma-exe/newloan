...
<title>Create Account — Prosperity Loans Portal</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
<link href="https://fonts.googleapis.com/css2?family=DM Sans:wght@300;400;500;600;700&family=Cormorant+Garamond:ital,wght@0,400;0,600;0,700;1,400&display=swap" rel="stylesheet">
...
.auth-top {
  background: linear-gradient(135deg, #0f4527, #22894e);
  padding: 28px 36px 24px;
  display: flex; align-items: center; justify-content: space-between;
}
.auth-top img { height: 36px; object-fit: contain; display: block; }
.auth-top-text { text-align: right; }
.auth-top-text h1 { font-family: 'Playfair Display', serif; font-size: 22px; font-weight: 700; color: #fff; }
...
.fc {
  ...
  border: 1.5px solid #d4e0d4; border-radius: 7px;
...
.phone-prefix {
  background: #f4f7f4; border: 1.5px solid #d4e0d4; border-right: none;
...
.btn-submit {
  ...
  box-shadow: 0 4px 16px rgba(15,69,39,.25);
}
.btn-submit:hover { background: linear-gradient(135deg, #1a6b3c, #1a6b3c); transform: translateY(-1px); }
...
.auth-footer a { color: #1a6b3c; font-weight: 600; text-decoration: none; }
.auth-footer a:hover { text-decoration: underline; }
.notice { font-size: 12px; color: #8aaa8a; line-height: 1.6; margin-top: 14px; }
  ...
  <div class="auth-body">
    ...
    <form method="POST" action="{{ route('borrower.register.post') }}">
      ...
      <div class="g2">
        ...
        <div class="fg">
          <label class="fl">Maiden Name <span style="color:#8aaa8a;text-transform:none;letter-spacing:0">(if any)</span></label>
          <div class="field-wrap">
      ...
      <div class="fg">
        <label class="fl">Phone Number * <span style="color:#8aaa8a;text-transform:none;letter-spacing:0">— used to log in</span></label>
      ...
      <div class="fg">
        <label class="fl">Email <span style="color:#8aaa8a;text-transform:none;letter-spacing:0">(optional)</span></label>
        <div class="field-wrap">
      ...
      <div class="fg">
        <label class="fl">Referral Code <span style="color:#8aaa8a;text-transform:none;letter-spacing:0">(optional)</span></label>
        <div class="field-wrap">
      ...
      <p class="notice">
        ...
        By registering you agree to our <a href="{{ route('terms') ?? '#' }}" style="color:#1a6b3c">Terms</a> and <a href="{{ route('privacy') ?? '#' }}" style="color:#1a6b3c">Privacy Policy</a>.
      </p>
    </form>
