...
@section('content')
  ...
  <div class="credit-hero-card">
    <div style="position:relative; z-index:2">
      <div style="display:flex; justify-content:space-between; align-items:flex-start">
        <div>
          <div style="display:flex; align-items:center; gap:8px; margin-bottom:8px">
            ...
            <span
              style="font-size:11px; font-weight:800; color:rgba(255,255,255,0.6); text-transform:uppercase; letter-spacing:2px">Available
              Balance</span>
          </div>
        ...
        <div style="text-align:right">
          <div
            style="font-size:11px; color:rgba(255,255,255,0.5); font-weight:700; text-transform:uppercase; letter-spacing:1px; margin-bottom:4px">
            Spending Limit</div>
      ...
      <div style="margin-top:40px">
        <div
          style="background:rgba(255,255,255,0.1); border-radius:100px; height:10px; overflow:hidden; border:1px solid rgba(255,255,255,0.05)">
          <div
            style="background:linear-gradient(90deg, #3b82f6, #60a5fa); height:100%; width:{{ 100 - $pct }}%; border-radius:100px; transition:width 1.5s ease">
          </div>
        </div>
        <div
          style="display:flex; justify-content:space-between; font-size:13px; margin-top:14px; color:rgba(255,255,255,0.7); font-weight:700">
  ...
  <div style="margin-bottom:40px">
    <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:28px">
      ...
      <span style="font-size:12px; color:#94a3b8; font-weight:700; text-transform:uppercase; letter-spacing:1px">CPay
        Integrated</span>
    </div>
    ...
    <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(320px, 1fr)); gap:24px">
      ...
      {{-- Electricity --}}
      <a href="{{ route('borrower.mybill.purchase', 'electricity') }}" class="image-card"
        style="background-image: url('https://ik.imagekit.io/ygydr1m84/electricity.png')">
        <div class="image-card-overlay">
          ...
          <div style="display:flex; justify-content:space-between; align-items:center">
            ...
            <div style="font-size:11px; font-weight:800; color:rgba(255,255,255,0.7); text-transform:uppercase">LEC
              Partner</div>
          </div>
        </div>
      </a>
      ...
      {{-- Airtime --}}
      <a href="{{ route('borrower.mybill.purchase', 'airtime') }}" class="image-card"
        style="background-image: url('https://ik.imagekit.io/ygydr1m84/airtime.png')">
        <div class="image-card-overlay">
          <div style="flex:1">
          ...
          <div style="display:flex; justify-content:space-between; align-items:center">
            ...
            <div style="display:flex; gap:6px">
              <div
                style="font-size:10px; font-weight:800; color:#fff; background:rgba(0,0,0,0.3); padding:2px 8px; border-radius:4px">
                VCL</div>
              <div
                style="font-size:10px; font-weight:800; color:#fff; background:rgba(0,0,0,0.3); padding:2px 8px; border-radius:4px">
                ETL</div>
      ...
      {{-- Insurance --}}
      <a href="{{ route('borrower.mybill.purchase', 'insurance') }}" class="image-card"
        style="background-image: url('https://ik.imagekit.io/ygydr1m84/insurance.png')">
        <div class="image-card-overlay">
          <div style="flex:1">
          ...
          <div style="display:flex; justify-content:space-between; align-items:center">
            ...
            <div style="font-size:11px; font-weight:800; color:rgba(255,255,255,0.7); text-transform:uppercase">Trusted
            </div>
          </div>
        </div>
      </a>
      ...
      {{-- Tickets --}}
      <a href="{{ route('borrower.mybill.purchase', 'ticket') }}" class="image-card"
        style="background-image: url('https://ik.imagekit.io/ygydr1m84/tickets.png')">
        <div class="image-card-overlay">
          <div style="flex:1">
          ...
          <div style="display:flex; justify-content:space-between; align-items:center">
            ...
            <div style="font-size:11px; font-weight:800; color:rgba(255,255,255,0.7); text-transform:uppercase">Live
              Events</div>
          </div>
        </div>
      </a>
  ...
  <div class="recent-list-glass">
    <div
      style="padding:24px; display:flex; align-items:center; justify-content:space-between; border-bottom:1px solid rgba(0,0,0,0.05)">
      <span style="font-size:16px; font-weight:900; color:#0f172a">Recent Activity</span>
      <a href="{{ route('borrower.mybill.history') }}"
        style="font-size:13px; color:#3b82f6; text-decoration:none; font-weight:800">History & Details</a>
    </div>
      ...
      @forelse($loans as $loan)
        <a href="{{ route('borrower.mybill.show', $loan) }}" class="txn-item">
          ...
          <div style="flex:1">
            ...
            <div style="font-size:12px; color:#94a3b8; font-weight:600">{{ $loan->created_at->format('d M, H:i') }} ·
              #{{ $loan->loan_number }}</div>
          </div>
          <div style="text-align:right">
            <div style="font-weight:900; font-size:18px; color:#0f172a">M {{ number_format($loan->bill_value, 2) }}</div>
            <div
              style="font-size:10px; font-weight:900; color:{{ $loan->status === 'settled' ? '#10b981' : '#f59e0b' }}; text-transform:uppercase; letter-spacing:1px">
              {{ $loan->status }}
            </div>
          </div>
        </a>
