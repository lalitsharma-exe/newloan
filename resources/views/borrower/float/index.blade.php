            ...
            <div class="card-body" style="padding: 40px; position: relative; z-index: 2;">
                <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 32px;">
                    <div>
                        ...
                        <div style="font-size: 48px; font-weight: 800; font-family: 'Playfair Display', serif; margin-top: 4px;">M {{ number_format($activeFloat->outstanding_balance, 2) }}</div>
                    </div>
...
@elseif($user->float_eligible)
    ...
    <div class="card" style="border: none; border-radius: 24px; overflow: hidden; background: #0f172a; position: relative; min-height: 400px; display: flex; align-items: center;">
        ...
        <div style="position: relative; z-index: 2; padding: 60px; max-width: 600px;">
            ...
            <h2 style="font-family: 'Playfair Display', serif; font-size: 52px; font-weight: 700; color: #fff; line-height: 1; margin-bottom: 16px;">M500 in your wallet, <span style="color: var(--accent);">instantly.</span></h2>
...
@else
    ...
    <div class="card" style="text-align: center; padding: 60px 40px; border: 2px dashed var(--border); background: #fafbff;">
        ...
        <h2 style="font-family: 'Playfair Display', serif; font-size: 32px; font-weight: 700; color: var(--navy);">MyFloat Access Restricted</h2>
...
{{-- APPLICATION MODAL --}}
<div id="applyModal" style="display:none; position:fixed; inset:0; background:rgba(15,69,39,0.8); backdrop-filter:blur(10px); z-index:1000; align-items:center; justify-content:center; padding:20px;">
    <div style="background:#fff; width:100%; max-width:500px; border-radius:24px; overflow:hidden; animation: modalSlideUp 0.4s cubic-bezier(0.16, 1, 0.3, 1);">
        ...
        <form action="{{ route('borrower.float.apply') }}" method="POST" style="padding:32px;">
            ...
            <button type="submit" class="btn" style="width: 100%; height: 52px; background: var(--navy); color: #fff; border-radius: 14px; font-weight: 700; font-size: 16px; justify-content: center; box-shadow: 0 10px 20px rgba(15, 69, 39, 0.2);">
