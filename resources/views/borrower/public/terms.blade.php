...
@section('meta_desc','MyLoan Limited Terms and Conditions of use for our website and borrower portal.')
...
<section>
  <div class="container">
    <div class="legal-body">
      ...
      <p>By accessing or using the MyLoan Limited website and borrower portal, you agree to be bound by these Terms and Conditions. If you do not agree, please do not use our services.</p>

      <h2>2. About MyLoan Limited</h2>
      <p>MyLoan Limited is a Credit Only Micro Finance Institution Tier II, licensed under the Financial Institutions Act 2012 and regulated by the Central Bank of Lesotho. We are incorporated and operate in the Kingdom of Lesotho.</p>

      <h2>3. Eligibility</h2>
      <p>To apply for a loan through MyLoan, you must:</p>
      <ul>
      ...
      <h2>6. Portal Use</h2>
      <p>You are responsible for maintaining the confidentiality of your portal login credentials. You agree not to share your username and password with any other person. MyLoan will not be liable for any loss arising from unauthorised access to your account due to your failure to protect your credentials.</p>

      <h2>7. Intellectual Property</h2>
      <p>All content on this website — including text, graphics, logos, and software — is the property of MyLoan Limited and is protected by applicable intellectual property laws. You may not reproduce or distribute any content without our prior written consent.</p>

      <h2>8. Limitation of Liability</h2>
      <p>MyLoan Limited is not liable for any indirect, incidental, or consequential damages arising from your use of this website or portal. Our total liability to you shall not exceed the value of any fees you have paid to us in the preceding 3 months.</p>
      ...
      <h2>11. Contact</h2>
      <p>For questions about these Terms, please contact us at info@myloan.co.ls or call (+266) 58 478 799.</p>
    </div>
  </div>
</section>
@endsection
