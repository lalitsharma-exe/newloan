...
@section('meta_desc', 'Learn about Prosperity Loans Limited — our mission, vision, and commitment to providing simple, fast and secure financial solutions in Lesotho.')
  ...
  <div class="container">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:72px;align-items:start">
      <div class="reveal">
        ...
        <p style="margin-bottom:18px">Prosperity Loans Limited is a registered microfinance institution based in Maseru, Lesotho. We were founded with a single purpose: to provide simple, accessible, and honest financial solutions to working Basotho who need them most.</p>
      ...
      <div class="reveal d2">
        <div style="background:var(--ivory);border-radius:6px;padding:36px 32px;border:1px solid var(--border)">
          ...
          <p style="font-family:'Playfair Display',serif;font-size:22px;color:var(--ink);font-style:italic;line-height:1.55;margin-bottom:24px">&ldquo;To provide simple, fast, and secure financial solutions that empower people to meet their financial needs.&rdquo;</p>
          <hr style="border:none;border-top:1px solid var(--border);margin-bottom:24px">
          <div class="eyebrow">Our Vision</div>
          <p style="font-family:'Playfair Display',serif;font-size:22px;color:var(--ink);font-style:italic;line-height:1.55">&ldquo;To become a leading and trusted financial services provider in Lesotho.&rdquo;</p>
        </div>
      </div>
    </div>
  </div>
