...
@section('bc')
<a href="{{ route('admin.loans.index') }}">Loans</a> / <a href="{{ route('admin.loans.show', $loan) }}">{{ $loan->loan_number }}</a> / Statement
@endsection
@section('content')
...
<div class="stmt-wrap">
  ...
  <div class="stmt-actions no-print">
    <a href="{{ route('admin.loans.show', $loan) }}" class="btn btn-o btn-sm"><i class="bi bi-arrow-left"></i> Back</a>
