...
<div>
  ...
  <div class="tpanel" data-pg="app" data-p="afford">
    ...
    @if($a)
      ...
      @else
      <div style="background:rgba(22,163,74,.08);border:1px solid rgba(22,163,74,.2);border-radius:12px;padding:12px 18px;display:flex;align-items:center;gap:10px;margin-bottom:16px">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-top:16px">
          <div style="background:{{ ($a->disposable_income??0)>0?'rgba(22,163,74,.08)':'rgba(239,68,68,.06)' }};border-radius:12px;padding:18px;text-align:center;border:1px solid {{ ($a->disposable_income??0)>0?'rgba(22,163,74,.2)':'rgba(239,68,68,.2)' }}">
  ...
  <div class="tpanel" data-pg="app" data-p="loan">
    ...
    <div style="background:linear-gradient(135deg,rgba(22,163,74,.07),rgba(5,150,105,.04));border:1px solid rgba(22,163,74,.25);border-radius:14px;padding:20px;margin-bottom:16px">
