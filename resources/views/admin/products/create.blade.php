...
@section('page-title', 'Create Loan Product')
@section('bc')
    ...
    <form method="POST" action="{{ route('admin.products.store') }}">
        ...
        <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 24px; align-items: start;">
            ...
            <div style="display: flex; flex-direction: column; gap: 24px;">
                ...
                <div class="card">
                    <div class="card-hdr">
                        <span class="card-title"><i class="bi bi-plus-circle" style="color: var(--ok);"></i> Product Details</span>
                    </div>
                    <div class="card-body">
                        <div class="fg">
                            <label class="fl">Product Name *</label>
                            <input type="text" name="name" class="fc" value="{{ old('name') }}" required placeholder="e.g. Executive Personal Loan">
                            <span class="ft">The public name of the loan product visible to borrowers.</span>
                        </div>
                        
                        <div class="fg" style="margin-top: 16px;">
                            <label class="fl">Description</label>
                            <textarea name="description" class="fc" rows="3" placeholder="Briefly describe the product's target audience or benefits...">{{ old('description') }}</textarea>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="g2" style="gap: 20px;">
                            <div class="fg">
                                ...
                                <select name="interest_method" class="fc" required>
                                    <option value="flat" {{ old('interest_method') === 'flat' ? 'selected' : '' }}>Flat Rate (Fixed)</option>
                    ...
                    <div class="card-body">
                        <div class="g2" style="gap: 20px;">
                            ...
                            <div class="fg">
                                ...
                                <input type="number" name="max_amount" class="fc" value="{{ old('max_amount', 5000) }}" min="1" required>
                            </div>
                            <div class="fg">
                                <label class="fl">Min Term (Months) *</label>
                                <input type="number" name="min_term_months" class="fc" value="{{ old('min_term_months', 1) }}" min="1" required>
                            </div>
                            <div class="fg">
                                <label class="fl">Max Term (Months) *</label>
                                <input type="number" name="max_term_months" class="fc" value="{{ old('max_term_months', 6) }}" min="1" max="60" required>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="fg">
                            ...
                            <textarea name="eligibility_criteria" class="fc" rows="4" placeholder="e.g. Minimum salary M5,000, Proof of employment for 6 months...">{{ old('eligibility_criteria') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body" style="padding: 20px;">
                        <div style="margin-bottom: 20px;">
                            <label style="display: flex; align-items: center; justify-content: space-between; cursor: pointer; background: #f8fafc; padding: 12px; border-radius: 8px; border: 1px solid var(--border);">
                                <span style="font-weight: 700; color: var(--navy); font-size: 14px;">Set as Active</span>
                                <input type="checkbox" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} style="width: 18px; height: 18px; accent-color: var(--ok);">
                            </label>
                        </div>
