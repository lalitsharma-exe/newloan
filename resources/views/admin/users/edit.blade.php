  ...
  <form method="POST" action="{{ route('admin.users.update', $user) }}">
    ...
    <div class="card-body">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px">
        ...
        {{-- Maiden Name (borrowers) --}}
        <div class="fg" id="maidenNameField" style="display:{{ old('role',$user->role) === 'borrower' ? '' : 'none' }}">
          <label class="fl">Maiden Name <span style="color:var(--muted);font-weight:400;font-size:11px">(Name before marriage)</span></label>
          <input type="text" name="maiden_name" class="fc @error('maiden_name') err @enderror" value="{{ old('maiden_name', $user->maiden_name) }}" placeholder="Optional">
