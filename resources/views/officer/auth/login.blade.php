...
<title>Sign In — MyLoan Officer</title>
      ...
      <form method="POST" action="{{ route('officer.login.post') }}">
        ...
        <div class="fg">
          ...
          <div class="field-wrap">
            ...
            <button type="button" onclick="togglePw()" style="position:absolute;right:12px;top:50%;transform:translateY(-50%);background:none;border:none;cursor:pointer;color:#9aaccf;font-size:15px" id="pwToggle">
              <i class="bi bi-eye"></i>
            </button>
          </div>
        </div>
